...
bool mode_choose::init() {
	...
	auto exitbtnF = MenuItemLabel::create(labelF, CC_CALLBACK_1(mode_choose::returnMenu, this));
	auto exitF = Menu::create(exitbtnF, NULL);
	exitF->setPosition(Vec2(VisibleSize.width*0.9, VisibleSize.height*0.1));
...
//返回前一场景
void mode_choose::returnMenu(Ref* pSender) {
